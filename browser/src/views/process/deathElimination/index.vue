                ...
                <div class="demoTable">
                    <el-form :inline="true" :model="tableQuery" class="demo-form-inline" ref="tableQuery">
                        <el-form-item label="鸡场：" prop="farmId">
                            <el-select @change="farmChange(farmId)" v-model.trim="tableQuery.farmId" placeholder="请选择鸡场" class="inputStyle">
                                <el-option
                ...
                <el-row>
                    ...
                    <el-col :span="11">
                        <el-form-item label="类型：" prop="type">
                            <el-select v-model.trim="temp.type" placeholder="请选择类型" style="width: 220px" >
                                <el-option
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="数量：" prop="count">
                            <el-input v-model.trim="temp.count" placeholder="请输入数量" style="width: 220px" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="11">
                        <el-form-item label="原因：" prop="reason">
                            <el-input v-model.trim="temp.reason" placeholder="原因" style="width: 220px" />
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="备注：" prop="remark">
                            <el-input type="textarea" v-model.trim="temp.remark" placeholder="请输入原因" />
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <el-dialog :visible.sync="dialogEditFormVisible" :modal-append-to-body='false'>
            <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="120px" style = "margin-top:20px" >
                ...
                <el-row>
                    <el-col :span="11">
                        <el-form-item label="备注：" prop="remark">
                            <el-input type="textarea" v-model.trim="temp.remark" placeholder="请输入原因" style="width: 220px" />
                        </el-form-item>
                    </el-col>
                </el-row>
    ...
    export default {
        ...
        methods: {
            ...
            init(){
                this.$http({
                    method: "post",
                    url: "/web-server/process/deathElimination/query.json?action=init"
                }).then(res => {
                    this.farmData = res.data.data.listFarm;
                    this.typeData = res.data.data.listType;
            ...
            fetchData(current) {
                ...
                this.$http({
                    method: "post",
                    url: "/web-server/process/deathElimination/query.json?action=query",
                    data: params
                }).then(res => {
            ...
            createData() {
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    params.append("count", this.temp.count);
                    params.append("reason", this.temp.reason);
                    params.append("remark", this.temp.remark);
                    this.$http({
                        method: "post",
                        url: "/web-server/process/deathElimination/query.json?action=save",
                        data: params
                    }).then(res => {
            ...
            handleEdit(row){
                ...
                let params = new URLSearchParams();
                params.append("eliminationId", row.id);
                params.append("farmId", row.farmId);
                params.append("houseId", row.houseId);
                this.$http({
                    method: "post",
                    url: "/web-server/process/deathElimination/query.json?action=editHandle",
                    data: params
                }).then(res => {
                    this.houseData = res.data.data.listHouse;
                    this.chicksCcsData = res.data.data.listChicksCcs;
                    this.temp = Object.assign({}, res.data.data.deathElimination)
            ...
            removeBatch(rows) {
                ...
                this.$confirm('确定要删除选中的行吗?', '提示').then(() => {
                    this.$http({
                        method: "post",
                        url: "/web-server/process/deathElimination/query.json?action=delete",
                        data: params
                    }).then(res => {
            ...
            farmChange(farmId) {
                ...
                this.$http({
                    method: "post",
                    url: "/web-server/process/deathElimination/query.json?action=queryHouse",
                    data: params
                }).then(res => {
                    this.houseData = res.data.data;
                    // this.chickData = res.data.data.chicksList;
                })
                    .catch(err => {
                        console.log(err);
                    });
            ...
            houseChange(houseId) {
                ...
                this.$http({
                    method: "post",
                    url: "/web-server/process/deathElimination/query.json?action=queryChicksCcs",
                    data: params
                }).then(res => {
            ...
            dateFormat(row, column){
                ...
                return utils.formatTime(new Date(date),"yyyy-MM-dd")
            }
        }
    }
</script>
