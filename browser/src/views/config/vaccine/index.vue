    ...
    <div class="">
        <div class="demoTable">
            <el-form :inline="true" :model="tableQuery" class="demo-form-inline">
                ...
                <el-form-item label="疫苗生产企业：">
                    <el-input v-model.trnpmim="tableQuery.producer" placeholder="请输入生产企业"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <div class="demoTable">
            <el-table
                ...
                <el-table-column prop="against_sickness" label="疾病预防"></el-table-column>
        ...
        <el-dialog :visible.sync="dialogCreateFormVisible" :modal-append-to-body='false'>
            <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="120px" style = "margin-top:20px">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="疫苗名称：" prop="name">
                            <el-input v-model.trim="temp.name" placeholder="请输入疫苗名称"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="疫苗生产企业：" prop="producer">
                            <el-input v-model.trim="temp.producer" placeholder="请输入疫苗生产企业"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="预防疾病：" prop="againstSickness">
                            <el-input v-model.trim="temp.againstSickness" placeholder="请输入预防疾病"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
   ...
   export default {
       ...
       data() {
           return {
               rules:{
                   ...
                   producer: [{ required: true, message: '请输入疫苗生产企业', trigger: 'blur' }],
       ...
       methods: {
           ...
           fetchData(current) {
               ...
               this.$http({
                   method: "post",
                   url: "/web-server/config/vaccine/query.json?action=query",
                   data: params
               }).then(res => {
           ...
           createData() {
               this.$refs['dataForm'].validate((valid) => {
                   ...
                   params.append("againstSickness", this.temp.againstSickness);
                   ...
                   this.$http({
                       method: "post",
                       url: "/web-server/config/vaccine/query.json?action=save",
                       data: params
                   }).then(res => {
           ...
           //修改
           handleEdit(vaccineId){

               let params = new URLSearchParams();
               params.append("vaccineId", vaccineId);
               this.$http({
                   method: "post",
                   url: "/web-server/config/vaccine/query.json?action=getVaccine",
                   data: params
               }).then(res => {
           ...
           removeBatch(rows) {
               ...
               this.$confirm('确定要删除选中的行吗?', '提示').then(() => {
                   this.$http({
                       method: "post",
                       url: "/web-server/config/vaccine/query.json?action=delete",
                       data: params
                   }).then(res => {
					   this.fetchData();
