<template>
    ...
    <div class="container">
        ...
        <div style="padding:30px 80px;">
            <!-- 头部信息 -->
            <div class="header">
                <img src="@/assets/shuidao.jpg" style="height:100px;">
                <h1 style="display:inline-block;padding:2% 0 0 2%;">{{ title }}</h1>

                <!-- 为您推荐 -->
                <p>
                    为您推荐：<span v-for="(item, index) in recommends" :key="index">
                        <a href="javascript:void(0);">{{ item }}</a></span>
                </p>
            </div>

            <!-- 主体内容 -->
            <div class="main" v-for="(maincontent, index) in mainContents" :key="index">
...
export default {
    data() {
        return{
            title: this.$route.params.obj,
            img: '',
            recommends: ['水稻作物', '水稻品种', '水稻学家'],
            mainContents: [
                {
                    title: '养鸡从门到精通',
                    pubdate: '2019年11月1日',
