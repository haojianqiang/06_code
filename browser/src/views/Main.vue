      ...
      <el-container>
              ...
              <el-col :span="24">
                <div class="myBorder" ref="leftTwo" id="leftTwo">
                  ...
                  <div style="margin-bottom:4%" class="myStyle">
                    ...
                    <el-date-picker v-model="startTime" size="small" type="date" placeholder="选择日期"></el-date-picker>
                    <span>---</span>
                    <el-date-picker v-model="endTime" size="small" type="date" placeholder="选择日期"></el-date-picker>
                  </div>
          ...
          <div class="myBorder myStyle">
            <el-row>
              ...
              <el-col :span="8">
                ...
                <el-select
                  v-model="chickenHouse"
                  size="small"
                  clearable
                  placeholder="请选择"
                  @change="DropdownBoxChickenHouse()"
                >
                  <el-option
              ...
              <div class="myPadding">
                ...
                >
                  <el-table-column label="预警信息">
                    <el-table-column prop="farmName" label="鸡场" width="180"></el-table-column>
                    <el-table-column prop="houseName" label="鸡棚" width="180"></el-table-column>
                    <el-table-column prop="configValue" label="预警项"></el-table-column>
        ...
        <el-main>
          <div class="myBorder">
            ...
            <el-row>
              <div class="span-text-2">
                <span class="bullStyle">&bull;</span>成交信息
              </div>
              <div id="drawProduction"></div>
            </el-row>
            <el-row>
              <div class="span-text-2">
                <span class="bullStyle">&bull;</span>育成率、死亡率百分比
              </div>
              <el-col :span="12">
            ...
            <el-row>
              <el-col>
                <div class="span-text-2">
                  <span class="bullStyle">&bull;</span>饲料及药物用量
                </div>
                <div class="myStyle">
                  <span class="span-text-1">时间：</span>
                  <el-date-picker
                  ...
                  ></el-date-picker>
                  <span>---</span>
                  <el-date-picker v-model="endTimeTwo" size="small" type="date" placeholder="选择日期"></el-date-picker>
                </div>
              </el-col>
            </el-row>
            <div style="margin: 2%;display: flex;" class="myStyle">
              <el-table
                ...
                style="width: 50%"
              >
                <el-table-column prop="feedName" label="饲料名称"></el-table-column>
                <el-table-column prop="feedDosage" label="饲料用量"></el-table-column>
              </el-table>
              <el-table
                :data="medicineList"
                height="150"
                ...
                style="width: 50%"
              >
                <el-table-column prop="medicineName" label="药物名称"></el-table-column>
                <el-table-column prop="medicineDosage" label="药物用量"></el-table-column>
              </el-table>
            </div>
          </div>
        </el-main>
...
export default {
  ...
  methods: {
    ...
    drawDepositInfoChart() {
      ...
      this.drawDepositInfo = echarts.init(
        document.getElementById("drawDepositInfo")
      );
    ...
    drawTemperatureChart() {
      this.drawTemperature = echarts.init(
        document.getElementById("drawTemperature")
      );
      var numberOfBarsList = [];
      var valueList = [];
      var seriesContent = [];
    ...
    drawProductionChart() {
      ...
      this.drawProduction = echarts.init(
        document.getElementById("drawProduction")
      );
    ...
    drawBreedingRateChart() {
      this.drawBreedingRate = echarts.init(
        document.getElementById("drawBreedingRate")
      );
    ...
    //死亡率(扇形仿仪表盘)
    drawMortalityChart() {
      this.drawMortality = echarts.init(
        document.getElementById("drawMortality")
      );
    ...
    drawCharts() {
      ...
      drawTemperature.style.width = window.innerWidth * 0.2 + "px";
    ...
    tableHeaderColor({ rowIndex, columnIndex }) {
      ...
      return (
        "background-color: #132F58;color: #02ccce;font-weight: 300;font-size:14px;" +
        returnStyle
      );
    },
    ...
    cellStyle({ columnIndex }) {
      ...
      return (
        "border-bottom: none;border-right:1px solid #03559d; color: #fff;font-weight: 300;" +
        returnStyle
      );
    }
  },
  ...
  mounted: function() {
    ...
    window.onresize = () => {
      ...
      leftOneHeight.style.height =
        document.documentElement.clientHeight * 0.25 + "px";

      let leftTwoHeight = document.getElementById("leftTwo");
      leftTwoHeight.style.height =
        document.documentElement.clientHeight * 0.3 + "px";
