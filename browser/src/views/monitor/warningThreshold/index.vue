    ...
    <el-row :gutter="20" style="margin-top:30px;margin-left:30px;margin-right:30px">
            ...
            <div class="grid-content bg-purple">
                ...
                <div style=" margin-left:20px; margin-top:60px;">
                   <el-row style=" margin-bottom:30px">
                       <el-col :span="6" style="text-align:right;padding-top:5px" ><div>温度值：</div></el-col>
                       <el-col :span="6"><div><el-input v-model.trim="temperature_lowerLimit.configValue" size="small" placeholder="请输入下限值"/></div></el-col>
                       <el-col :span="6" style=" margin-left:15px"><div> <el-input v-model.trim="temperature_upperLimit.configValue" size="small" placeholder="请输入上限值"/></div></el-col>
                   </el-row>

                   <el-row style=" margin-bottom:30px" >
                        <el-col :span="6" style="text-align:right;padding-top:5px" ><div>湿度值：</div></el-col>
                        <el-col :span="6"><div> <el-input v-model.trim="humidity_lowerLimit.configValue" size="small" placeholder="请输入下限值"/></div></el-col>
                        <el-col :span="6" style=" margin-left:15px" ><div><el-input v-model.trim="humidity_upperLimit.configValue" size="small" placeholder="请输入上限值"/></div></el-col>
                   </el-row>

                   <el-row style=" margin-bottom:30px" >
                         <el-col :span="6" style="text-align:right;padding-top:5px" ><div>氨气浓度：</div></el-col>
                         <el-col :span="6"><div><el-input v-model.trim="nh3_lowerLimit.configValue" size="small" placeholder="请输入下限值"/></div></el-col>
                         <el-col :span="6" style=" margin-left:15px" ><div><el-input v-model.trim="nh3_upperLimit.configValue" size="small" placeholder="请输入上限值"/></div></el-col>
                   </el-row>

                   <el-row style=" margin-bottom:30px" >
                         <el-col :span="6" style="text-align:right;padding-top:5px"><div>二氧化碳浓度：</div></el-col>
                         <el-col :span="6"><div> <el-input v-model.trim="co2_lowerLimit.configValue" size="small" placeholder="请输入下限值"/></div></el-col>
                         <el-col :span="6" style=" margin-left:15px" ><div><el-input v-model.trim="co2_upperLimit.configValue" size="small" placeholder="请输入上限值"/></div></el-col>
                   </el-row>
                </div>
                <div style="background: #e5e9f2;text-align:center;margin-top:110px;">
                    <el-button style="background-color: #3ebf7c" @click="saveConfig" size="small" type="success" class="btn-save"
                               clicked="0">保存
                    </el-button>
                </div>
            </div>
        ...
        <el-col :span="5">
            <div class="grid-content bg-purple">
                ...
                <el-select v-model="houseIds" multiple  placeholder="请选择鸡棚" size="small" @change="houseSelectValueChange">
