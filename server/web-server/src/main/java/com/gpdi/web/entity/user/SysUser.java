package com.gpdi.web.entity.user;
...
public class SysUser implements Serializable{
    ...
    private Integer orgId; // 组织机构ID(未使用)
    private String postLevel; // 岗位等级(未使用)
    private Date pwdLastModtime; // 最后一次密码更改时间
    private String staffId; //(未使用)
    private String navId; // 菜单ID
